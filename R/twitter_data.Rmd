...
morning_retweeters = morning_retweeters %>%
  filter(location != "")
morning_retweeters$user_id = gsub("x", "", as.character(morning_retweeters$user_id))
...
afternoon_retweeters = afternoon_retweeters %>%
  filter(location != "")
afternoon_retweeters$user_id = gsub("x", "", as.character(afternoon_retweeters$user_id))
